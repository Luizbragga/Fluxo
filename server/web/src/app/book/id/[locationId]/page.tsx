...
export default function BookPage() {
  ...
  // ranges ocupados (appointments + blocks) em minutos (dia local)
  ...
  // 1) Carrega dados públicos da location (por ID)
  useEffect(() => {
    let alive = true;
  ...
  // 2) quando mudar serviço/profissional/dia, reseta horário
  useEffect(() => {
            ...
            {noProviders || noServices ? (
              ...
              <div className="grid grid-cols-4 gap-2">
                {daySlots.map((t) => {
                  ...
                  // passou = quando o serviço inteiro já terminaria no passado
                  const past = isToday && eMin <= nowMinutes;

                  // busy = overlap com qualquer appointment/block
